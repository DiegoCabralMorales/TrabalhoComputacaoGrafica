...
vec3 lightColor3 = vec3(1.0, 1.0, 1.0); // Luz 3 agora é branca
...
void main(){
    ...
    vec3 lightContribution1 = calculateLight(lightPos1, lightColor1);
    vec3 lightContribution2 = calculateLight(lightPos2, lightColor2);
    vec3 lightContribution3 = calculateLight(lightPos3, lightColor3);

    // Soma todas as contribuições de luz (ambiente, difusa e especular de cada luz).
    vec3 totalLighting = ambient + lightContribution1 + lightContribution2 + lightContribution3;
